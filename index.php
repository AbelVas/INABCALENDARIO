...
<body>
   ...
   <div class="text-center">
        <img src="images/inabhorizontal.png" alt="" style="width:600px;height:180px;">
        <img src="images/reainfor.png" alt=""  style="width:400px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <div class="container">
        <h1 class="text-center"><b>Instituciones involucradas</b></h1>
         <div class="row">
          ...
          <div class="col-lg-4 col-md-2 col-sm-6 col-xs-12">
          <br><br><br>
            <div class="text-center"><img src="images/reainfor.png" alt="" class="img-responsive center-block"  style=""></div>
            <br>

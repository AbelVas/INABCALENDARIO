    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
     ...
     <div class="padding">
       <div class="container">
        ...
        <hr>
        <h5 class="text-center">* El calendario muestra las actividades tres d&iacuteas antes y tres despu&eacutes del d&iacutea &oacuteptimo para un total de 7 d&iacute;as</h5>
        <hr> 
        <div class="row">
         
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="CalendarioWeb"></div>
         </div><br>
         <h3 class="text-center"><a href="../images/guia-calendario.pdf" download="Guia de usuario - Calendario Forestal.pdf" id="descargarguiainab" style="color:#000"><i class="fas fa-file-download"></i>&nbsp; Descargar Gu&iacutea para el uso del calendario forestal Proporcionada por INAB</a></h3>
    ...
    ?>
      <script>
        ...
        <?php $date=date_create($datoos[7]);
         $menosTresDias = date ('Y-m-d', strtotime ('- 4 day', strtotime($datoos[7])));
...
<div>
       <div class="row">
       <img src="../images/Portada2.jpg" alt="" class="img-responsive center-block"  style="">
       </div>
